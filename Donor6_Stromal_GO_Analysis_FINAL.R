...
file_dir <- paste(getwd(),"\\Stromal_DEA\\15_Log2FC",sep="")
file_dir <- dir(file_dir)
num_files <- length(file_dir)

output_dir <- paste(getwd(),"\\Stromal_DEA_GSEA",sep="")
...
for (i in 1:num_files) {
  ...
  this_type_degs <- paste(getwd(),"\\Stromal_DEA\\15_Log2FC\\",this_file,sep="")
